...
python main.py ctdet --exp_id coco_mobilenetv2_10_224 --arch mobilenetv2_10  --dataset bdd --batch_size 16 --lr 5e-4 --gpus 0  --lr_step 35 --num_epochs 120 --input_res 224  --num_workers 6 --save_all
# # test
