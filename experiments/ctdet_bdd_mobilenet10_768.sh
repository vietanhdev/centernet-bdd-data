...
python main.py ctdet --exp_id coco_mobilenetv2_10_512 --arch mobilenetv2_10  --dataset bdd --batch_size 8 --lr 5e-4 --gpus 0  --lr_step 70 --num_epochs 120 --input_res 768  --num_workers 6 --save_all --resume
# # test
